            ...
            <div className='grid grid-cols-4 gap-4 p-4'>
                <div className='col-span-1 rounded-lg p-4 bg-blue-100 text-gray-700'>
                    ...
                    <div className='space-y-2'>
                        ...
                        <button
                        className={`w-full p-2 rounded-lg transition-colors duration-300 text-white cursor-pointer ${tableFilter ? 'bg-amber-500 hover:bg-amber-600' : 'bg-amber-400 hover:bg-amber-500'}`}
                        onClick={() => setTableFilter(!tableFilter)}>
                            {tableFilter ? '✓ Table Questions' : 'Table Questions'}
                        </button>
                    </div>
                </div>
                {
